...
import 'package:flutter_study/day03/find/Company.dart';
import 'package:flutter_study/day03/find/CompanyItem.dart';
...
class _FindScreenState extends State<FindScreen> {
  ...
  getCompany() async{
    String url = 'http://m.app.haosou.com/index/getData?type=1&page=$pageNumber';
